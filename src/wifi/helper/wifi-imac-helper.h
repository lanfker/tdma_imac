#ifndef WIFI_IMAC_HELPER_H
#define WIFI_IMAC_HELPER_H
...
public:
   ...
   */
  static WifiImacChannelHelper Default (void);
   ...
   */
  Ptr<WifiImacChannel> Create (void) const;
 ...
 *
 */
class WifiImacPhyHelper : public WifiPhyHelper,
...
public:
   ...
   */
  static WifiImacPhyHelper Default (void);
