    ...
    case WIFI_MOD_CLASS_OFDM:
      {
        switch (payloadMode.GetBandwidth ())
          ...
          case 250000:
            return WifiPhy::GetOfdmRate250Kbps ();
          default:
...
WifiMode WifiPhy::GetOfdmRate250Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate250Kbps",
                                      WIFI_MOD_CLASS_OFDM,
                                      true,
                                      250000, 250000,
                                      WIFI_CODE_RATE_1_1,
...
public:
  Constructor ()
  {
    ...
    ns3::WifiPhy::GetOfdmRate250Kbps ();
