...
public:
  ...
  /* After a node starts backoff for data packets, it receives a RTS, this node should cancel its
   * current backoff action and start CTS backoff on condition that this CTS message needs backoff.
   */
  void ClearCurrentBackoff ();
  /**
