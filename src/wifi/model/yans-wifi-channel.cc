...
{
  // specify the i-th yanswifiphy to receive data.
  m_phyList[i]->StartReceivePacket (packet, rxPowerDbm, txMode, preamble);// m_phyList is of type vector<Ptr<YansWifiPhy> >
}
