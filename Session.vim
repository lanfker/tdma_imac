...
silent only
cd ~/workspace/iMac/tdma
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4456 src/wifi/model/mac-low.cc
badd +3 src/wifi/model/controller.h
badd +231 src/wifi/model/controller.cc
badd +44 src/wifi/model/settings.h
badd +136 src/wifi/model/mac-low.h
badd +120 src/core/model/simulator.cc
badd +855 src/core/model/simulator.h
badd +100 src/applications/model/imac-random-traffic-generator.cc
badd +67 src/applications/model/imac-random-traffic-generator.h
badd +1341 src/wifi/model/wifi-imac-phy.cc
badd +308 src/wifi/model/wifi-imac-phy.h
badd +842 src/wifi/model/interference-helper.cc
args src/wifi/model/mac-low.cc
edit src/wifi/model/mac-low.cc
...
exe 'vert 2resize ' . ((&columns * 30 + 84) / 169)
exe 'vert 3resize ' . ((&columns * 138 + 84) / 169)
argglobal
enew
file \[Buf\ List]
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4456 - ((21 * winheight(0) + 21) / 43)
